...
const AboutMe = () => {
  ...
  <div className="container" >
    ...
    <div class="col-md-3 mt-3 d-flex flex-column justify-content-center justify-content-md-start align-items-center align-items-md-start" style={{width:'540px'}}>
        ...
        <p style={{ fontFamily: 'Quicksand, sans-serif' , fontSize: '20px',textAlign: 'justify', color:'white'}}>My name is Adrien Ardra Ramadhan, and I am  a 3rd-year Computer Engineering student at Universitas Indonesia and experienced in mobile and web development. Currently looking for opportunities to enhance my skills towards achieving my career goals. Hit the button below and see my past projects.</p>
